...
To authenticate and make your domain easier for users to find, you can purchase a [place name](../add-place-name) that connects to your domain.
...
+ [Configure Your Domain Settings](../your-domain/configure-your-domain-settings)
+ [Add a Place Name](../your-domain/add-place-name)